...
<!-- sign-up -->
	...
	<div class="container">
		<h2 style="font-size: 50px">THANK YOU</h2>
                <p class='har' style="font-size: 20px">Your email have successfully sent. Our staff will contact you soon.</p>
	</div>
	</div>
<!-- //sign-up -->
<!-- footer -->
...
<script>
setTimeout(function () {
   //window.location.href = "https://www.ezecom.com.kh/our-services/enterprise-network/international-private-leased-circuit"; // (Real Server) will redirect to your blog page (an ex: blog.html)
   window.location.href = "http://dev1.ezecom.com.kh/our-services/enterprise-network/international-private-leased-circuit"; // (Server Test) will redirect to your blog page (an ex: blog.html)
}, 5000);
</script>
