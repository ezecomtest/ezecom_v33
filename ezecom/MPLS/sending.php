...
if($_SERVER["REQUEST_METHOD"] === "POST"){
    ...
    if($response["success"] === true){
        ...
        if(!$mail->Send()) {
            ...
            //header("Location: https://www.ezecom.com.kh/MPLS/thank-you.php"); // (Real Server)
			header("Location: http://dev2.ezecom.com.kh/MPLS/thank-you.php"); // (Server Test)
        }

    }else{
        //header("Location: https://www.ezecom.com.kh/MPLS/robot.php"); // (Real Server)
		header("Location: http://dev2.ezecom.com.kh/MPLS/robot.php"); // (Server Test)
    }
