...
<script>
setTimeout(function () {
   //window.location.href = "https://www.ezecom.com.kh/our-services/value-added-service/EzeTV"; // (Real Server) will redirect to your blog page (an ex: blog.html)
   window.location.href = "http://dev1.ezecom.com.kh/our-services/value-added-service/EzeTV"; // (Server Test) will redirect to your blog page (an ex: blog.html)
}, 5000);
</script>
