...
if($_SERVER["REQUEST_METHOD"] === "POST"){
    ...
    if($response["success"] === true){
        ...
        if(!$mail->Send()) {
            ...
            //header("Location: https://www.ezecom.com.kh/EzeTV/thank-you.php"); // (Real Server)
			header("Location: http://dev1.ezecom.com.kh/EzeTV/thank-you.php"); // (Server Test)
        }

    }else{
        //header("Location: https://www.ezecom.com.kh/EzeTV/robot.php"); // (Real Server)
		header("Location: http://dev1.ezecom.com.kh/EzeTV/robot.php"); // (Server Test)
    }
