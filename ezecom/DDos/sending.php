...
if($_SERVER["REQUEST_METHOD"] === "POST"){
    ...
    if($response["success"] === true){
        ...
        if(!$mail->Send()) {
            ...
            //header("Location: https://www.ezecom.com.kh/DDos/thank-you.php"); // (Real Server)
			header("Location: http://dev2.ezecom.com.kh/DDos/thank-you.php"); // (Server Test)
        }

    }else{
        //header("Location: https://www.ezecom.com.kh/DDos/robot.php"); // (Real Server)
		header("Location: http://dev2.ezecom.com.kh/DDos/robot.php"); // (Server Test)
    }
