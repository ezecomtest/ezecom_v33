...
<script type="text/javascript">
	...
	function customer_signup(){
		$.ajax({
			type: "POST",
			url: base_url+"our-services/ddos-saving",
...
<script>
	setTimeout(function () {
	   window.location.href = base_url+"our-services/cyber-security/ddos"; // (Server Test) will redirect to your blog page (an ex: blog.html)
	}, 5000);
</script>
