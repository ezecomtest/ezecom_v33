...
<script>
setTimeout(function () {
   //window.location.href = "https://www.ezecom.com.kh/our-services/cyber-security/ddos"; // (Real Server) will redirect to your blog page (an ex: blog.html)
   window.location.href = "http://dev2.ezecom.com.kh/our-services/cyber-security/ddos"; // (Server Test) will redirect to your blog page (an ex: blog.html)
}, 5000);
</script>
