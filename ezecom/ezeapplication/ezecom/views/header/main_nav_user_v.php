	...
	<div class="container">
		<nav id='cssmenu'>
			...
			<ul>
				...
				<li><a href="<?php echo base_url()?>">Our Company <span class="glyphicon glyphicon-menu-down resize-angle-down"></span></a>
					<ul>
				...
				<li><a href="<?php echo base_url()?>">Our Services <span class="glyphicon glyphicon-menu-down resize-angle-down"></span></a>
				   <ul>
				...
				<li><a href='<?php echo base_url()?>'>Support <span class="glyphicon glyphicon-menu-down resize-angle-down"></span></a>
					<ul>
