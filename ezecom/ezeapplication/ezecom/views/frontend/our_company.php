...
<li class="item-1722">
<a href="<?php echo base_url();?>ourcompany#career-opportunities"><div class="career"> </div>Carreers</a></li>
</ul>
...
<![endif]-->EZECOM was founded to serve the rapidly expanding enterprises and Residence users market in Cambodia. Launched in 2007, EZECOM has since become a leading provider for a wide variety of innovative communication services. EZECOM’s mission is “To be Cambodia’s premium Solutions provider of communications services through constant innovation &amp; improvement while contribute to society”.</p>
...
<h3 style="color: #58585a; font-weight: 500;"> Our Core Values</h3>
<ul>
...
<h2>Partnerships</h2>
<p style="text-align: center;"><a href="<?php echo base_url();?>ourpartnership#goodwill-partners">Good Will Partners</a></p>
...
<p>EZECOM’s CSR policy functions as a built-in, self-regulating mechanism where the company monitors and ensures its active compliance with the spirit of the law and ethical standards, and engages in actions that further the social good, beyond the interests of the firm and that required by law.</p>
<p>Our CSR aims to embrace responsibility for the company's actions and encourage a positive impact through its activities on the environment, consumers, employees, communities, stakeholders and other members of the public.</p>
<p>For instance, we have been providing free internet to support education projects through our own initiative, EZECAMPUS and our partners, Development Innovation and Friends International. We also supported the Secured Heritage project by providing a secure system to document and reconcile the Khmer Rouge era for public access to these archives. Apart from that, EZECOM is one of the members of CSR platform in Cambodia involving with a constantly changing roster of activities and events, including sponsoring concerts, sporting and educational events and technology summits.</p>
...
<div class="col-sm-2"> </div>
<div class="col-xs-12 col-sm-12 col-md-8">
<p>EZECOM is a company that knows the power of investment for our customers, their children &amp; our future. Our core values are sustainability, grassroots development and integrity and our partnerships reflect these values. EZECOM invests in technology, human resources, education and the revitalizing of Cambodian sport.</p>
<p>Innovation and progress lie at the heart of EZECOM’s success. We recognise that investing in and supporting our communities, we can help to build a more economically sustainable, educated and socially-inclusive society. That is why EZECOM actively invests in programmes which contribute to communities and the environment.</p>
<h3> </h3>
</div>
<div class="col-sm-2"> </div>
</div>
...
<p>EZECOM, Cambodia’s premium internet service provider, was found in 2007 to serve the rapidly expanding business and residential market in Cambodia. Our company has incorporated its own fibre optic, world Class Data center, VoIP, VPN, Cloud services and other VAS services for enterprise solutions with our world class 24/7 technical support.</p>
<p>We are now looking for dynamic, energetic and committed candidates to fill the position as:</p>
</div>
</div>
</div>
</div>
