					...
					<div class="row">
						...
						<div class="col-xl-8 col-lg-8 col-md-8 col-sm-12 col-xs-12">
							...
							<div class="tab-content">
									...
									<h1 class="faqheading q1" style="font-size: 17px;" data-toggle="collapse" data-parent="#accordion" data-target="#c1">Why is my internet so slow?</h1>
									...
									<p style="font-size: 17px;">Assuming that your colleagues are receiving emails but you cannot, here are a few scenarios could lead to identifying the issues.</p>
									<ul style="font-size: 17px;">
									<li>Wrong address</li>
									...
									<p style="font-size: 17px;">You need to delist your IP from the blacklist using the following methods:</p>
									<ul style="font-size: 17px;">
									...
									<h1 class="faqheading q4" style="font-size: 17px;" data-toggle="collapse" data-parent="#accordion" data-target="#e4">Why can I NOT send mail out?</h1>
									<div id="e4" class="panel-collapse collapse">
									<p style="font-size: 17px;">Many reasons might cause this issue:</p>
									<ul style="font-size: 17px;">
									...
									<p style="font-size: 17px;">There are several things you may need to do to protect your LAN from spam:</p>
									<ul style="font-size: 17px;">
									...
									<p style="font-size: 17px;">To set Auto Forward:</p>
									<ul style="font-size: 17px;">
									...
									<p style="font-size: 17px;">To set Auto Reply:</p>
									<ul style="font-size: 17px;">
									...
									<h1 class="faqheading q8" style="font-size: 17px;" data-toggle="collapse" data-parent="#accordion" data-target="#e8">Why do I receive so much spam?</h1>
									<div id="e8" class="panel-collapse collapse">
									<p style="font-size: 17px;">There are a few reasons that cause this:</p>
									<ul style="font-size: 17px;">
									...
									<h1 class="faqheading q10" style="font-size: 17px;" data-toggle="collapse" data-parent="#accordion" data-target="#e10">What kinds of error messages will I see if I am blocked?</h1>
