...
<script>
setTimeout(function () {
   //window.location.href = "https://www.ezecom.com.kh/our-services/internet-access/EzeSurf"; // (Real Server) will redirect to your blog page (an ex: blog.html)
   window.location.href = "http://dev1.ezecom.com.kh/our-services/internet-access/EzeSurf"; // (Server Test) will redirect to your blog page (an ex: blog.html)
}, 5000);
</script>
