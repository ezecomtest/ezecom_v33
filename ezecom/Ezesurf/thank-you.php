...
<script type="text/javascript">
	...
	function customer_signup(){
		$.ajax({
			type: "POST",
			url: base_url+"our-services/ezesurf-saving",
...
<script>
	setTimeout(function () {
	   window.location.href = base_url+"our-services/internet-access/EzeSurf"; // (Server Test) will redirect to your blog page (an ex: blog.html)
	}, 5000);
</script>
